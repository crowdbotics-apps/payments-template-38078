...
## Project Structure
    ...
    ├── payments_template_38078  # Django project configurations
...
1. Clone this repo and `cd payments_template_38078`
...
2. Clone this repo and `cd payments_template_38078`
